...
/* 
  ...
  https://create.arduino.cc/cloud/things/e632a9e3-11bd-44a3-bdad-150bcb52076c 
...
void loop() {
  ...
  Serial.println(".........Classroom Enviornment Data...........");
  Serial.print("Classroom Temperature =  ");
  Serial.print(temperature);
  Serial.print(" ");
  Serial.print(char(176));
  Serial.println("C");
  
  Serial.print("Classroom Humidity =  ");
